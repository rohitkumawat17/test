...
return [
    'modules' => [
        ...
        'Ecommerce121_AddStyleToCheckoutPage' => 1,
        'Ecommerce121_BssProductLabel' => 0,
        'Ecommerce121_Catalog' => 1,
        'Ecommerce121_CategoryAffiliates' => 1,
        'Ecommerce121_ChangeSkuConfigurable' => 1,
        'Ecommerce121_Core' => 1,
        'Ecommerce121_CustomBreadcrumbs' => 1,
        'Ecommerce121_CustomForms' => 1,
        'Ecommerce121_Customer' => 1,
        'Ecommerce121_ElasticSearch' => 1,
        'Ecommerce121_FixBulkActions' => 1,
        'Ecommerce121_FixPercentegeTierPrice' => 1,
        'Ecommerce121_FixProceedToCheckoutButton' => 1,
        'Ecommerce121_FixSavePaymentInformation' => 1,
        'Ecommerce121_FixSerializer' => 1,
        'Ecommerce121_KieferBlock' => 1,
        'Ecommerce121_LgsShippingMethod' => 1,
        'Ecommerce121_MailchimpPopUp' => 1,
        'Ecommerce121_MainCategoryShow' => 1,
        'Ecommerce121_Migration' => 1,
        'Ecommerce121_PrefixField' => 1,
        'Ecommerce121_ProductAttributes' => 1,
        'Ecommerce121_ProductLabelExtension' => 1,
        'Ecommerce121_SequenceOrder' => 1,
        'Ecommerce121_ShippingText' => 1,
        'Ecommerce121_StorePermissions' => 1,
        'Ecommerce121_TaxFree' => 0,
        'Ecommerce121_TeamEntity' => 1,
        'Ecommerce121_TeamFilterAttribute' => 0,
        'Ecommerce121_TeamLogin' => 1,
        'Ecommerce121_UpgradeTo231' => 1,
        'Eyemagine_HubSpot' => 1,
        'FutureActivities_FixCategoryImages' => 1,
        'Glew_Service' => 1,
        'Goivvy_DJS' => 1,
        'Gsx_Globalshopex' => 1,
        'I95Dev_CustomOptions' => 1,
        'I95Dev_Exportfix' => 0,
        'I95Dev_ShippingBar' => 1,
        'Kiefer_TeamStores' => 1,
        'Kiefer_TeamStoresCatalog' => 1,
        'Kiefer_TeamStoresLogo' => 1,
        'Klarna_Core' => 1,
        ...
        'MageMojo_ElasticSearch_Settings' => 1,
        ...
        'Snowdog_AdminOpenFilters' => 1,
        'Snowdog_BulkOrderGrid' => 1,
        'Snowdog_CategoryEditProductLink' => 1,
        'Snowdog_CategoryMobile' => 1,
        'Snowdog_ConfigurableOptionSort' => 1,
        'Snowdog_DailyDeals' => 0,
        'Snowdog_PaymentOrderExport' => 1,
        'Snowdog_SwatchImage' => 1,
        'Springbot_Main' => 0,
        'Springbot_Queue' => 0,
        'Temando_ShippingRemover' => 1,
        'TheLifeguardStore_CustomMenuItem' => 1,
        'TheLifeguardStore_ProcessOrders' => 1,
        'Vertex_Tax' => 1,
